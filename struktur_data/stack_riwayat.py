class _NodeRiwayat:
    def __init__(self, data):
        self.data = data      # data tindakan, misal string "Enqueue pasien Budi"
        self.next = None      # pointer ke node di bawahnya (tindakan sebelumnya)
class Stack:
    def __init__(self):
        self.top = None       # node paling atas stack
        self._jumlah = 0      # penghitung jumlah data dalam stack
    def is_empty(self):
    ...
    def display(self):
        ...
        while node_sekarang is not None:
            ...
            posisi += 1
    def __len__(self):
        # Memudahkan pemanggilan len(stack) dari main.py
